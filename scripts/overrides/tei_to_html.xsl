    ...
    <ul>
      <li>
        ...
        <xsl:choose>
          ...
          <xsl:otherwise>Transcribed from digital images or a microfilm reproduction of the original item. For a description of the editorial rationale behind our treatment of the correspondence, see our <a href="../about/encoding-guidelines#Correspondence">statement of editorial policy</a>.
